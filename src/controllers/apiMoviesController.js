...
const { getAllMovies, getMovieById, storeMovie, updateMovie, deleteMovie } = require("../services/moviesServices")
    ...
    store : async (req,res) => {
        try {
           ...
           if ([title, rating, release_date, awards].includes('' || undefined)){
                ...
                throw cerateError(400, 'Todos los campos son obligatorios')
